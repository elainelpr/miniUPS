...
class UA_package_delivered : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:UA_package_delivered) */ {
 public:
  ...
  // repeated int64 shipid = 1;
  int shipid_size() const;
  void clear_shipid();
  static const int kShipidFieldNumber = 1;
  ::google::protobuf::int64 shipid(int index) const;
  void set_shipid(int index, ::google::protobuf::int64 value);
  void add_shipid(::google::protobuf::int64 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
      shipid() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
      mutable_shipid();
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 > shipid_;
  ::google::protobuf::int64 seqnum_;
  friend struct ::protobuf_world_5fups_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
// required int64 originseqnum = 2;
inline bool UA_err::has_originseqnum() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void UA_err::set_has_originseqnum() {
  _has_bits_[0] |= 0x00000002u;
}
inline void UA_err::clear_has_originseqnum() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void UA_err::clear_originseqnum() {
  originseqnum_ = GOOGLE_LONGLONG(0);
  clear_has_originseqnum();
}
inline ::google::protobuf::int64 UA_err::originseqnum() const {
  // @@protoc_insertion_point(field_get:UA_err.originseqnum)
  return originseqnum_;
}
inline void UA_err::set_originseqnum(::google::protobuf::int64 value) {
  set_has_originseqnum();
  originseqnum_ = value;
  // @@protoc_insertion_point(field_set:UA_err.originseqnum)
}

// required int64 seqnum = 3;
inline bool UA_err::has_seqnum() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void UA_err::set_has_seqnum() {
  _has_bits_[0] |= 0x00000004u;
}
inline void UA_err::clear_has_seqnum() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void UA_err::clear_seqnum() {
  seqnum_ = GOOGLE_LONGLONG(0);
  clear_has_seqnum();
}
inline ::google::protobuf::int64 UA_err::seqnum() const {
  // @@protoc_insertion_point(field_get:UA_err.seqnum)
  return seqnum_;
}
inline void UA_err::set_seqnum(::google::protobuf::int64 value) {
  set_has_seqnum();
  seqnum_ = value;
  // @@protoc_insertion_point(field_set:UA_err.seqnum)
}
...
// required int64 seqnum = 3;
inline bool UA_truck_picked::has_seqnum() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void UA_truck_picked::set_has_seqnum() {
  _has_bits_[0] |= 0x00000002u;
}
inline void UA_truck_picked::clear_has_seqnum() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void UA_truck_picked::clear_seqnum() {
  seqnum_ = GOOGLE_LONGLONG(0);
  clear_has_seqnum();
}
inline ::google::protobuf::int64 UA_truck_picked::seqnum() const {
  // @@protoc_insertion_point(field_get:UA_truck_picked.seqnum)
  return seqnum_;
}
inline void UA_truck_picked::set_seqnum(::google::protobuf::int64 value) {
  set_has_seqnum();
  seqnum_ = value;
  // @@protoc_insertion_point(field_set:UA_truck_picked.seqnum)
}
...
// required int64 seqnum = 3;
inline bool AU_deliver_package::has_seqnum() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void AU_deliver_package::set_has_seqnum() {
  _has_bits_[0] |= 0x00000001u;
}
inline void AU_deliver_package::clear_has_seqnum() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void AU_deliver_package::clear_seqnum() {
  seqnum_ = GOOGLE_LONGLONG(0);
  clear_has_seqnum();
}
inline ::google::protobuf::int64 AU_deliver_package::seqnum() const {
  // @@protoc_insertion_point(field_get:AU_deliver_package.seqnum)
  return seqnum_;
}
inline void AU_deliver_package::set_seqnum(::google::protobuf::int64 value) {
  set_has_seqnum();
  seqnum_ = value;
  // @@protoc_insertion_point(field_set:AU_deliver_package.seqnum)
}
...
// repeated int64 shipid = 1;
inline int UA_package_delivered::shipid_size() const {
  return shipid_.size();
}
inline void UA_package_delivered::clear_shipid() {
  shipid_.Clear();
}
inline ::google::protobuf::int64 UA_package_delivered::shipid(int index) const {
  // @@protoc_insertion_point(field_get:UA_package_delivered.shipid)
  return shipid_.Get(index);
}
inline void UA_package_delivered::set_shipid(int index, ::google::protobuf::int64 value) {
  shipid_.Set(index, value);
  // @@protoc_insertion_point(field_set:UA_package_delivered.shipid)
}
inline void UA_package_delivered::add_shipid(::google::protobuf::int64 value) {
  shipid_.Add(value);
  // @@protoc_insertion_point(field_add:UA_package_delivered.shipid)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
UA_package_delivered::shipid() const {
  // @@protoc_insertion_point(field_list:UA_package_delivered.shipid)
  return shipid_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
UA_package_delivered::mutable_shipid() {
  // @@protoc_insertion_point(field_mutable_list:UA_package_delivered.shipid)
  return &shipid_;
}

// required int64 seqnum = 2;
inline bool UA_package_delivered::has_seqnum() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void UA_package_delivered::set_has_seqnum() {
  _has_bits_[0] |= 0x00000001u;
}
inline void UA_package_delivered::clear_has_seqnum() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void UA_package_delivered::clear_seqnum() {
  seqnum_ = GOOGLE_LONGLONG(0);
  clear_has_seqnum();
}
inline ::google::protobuf::int64 UA_package_delivered::seqnum() const {
  // @@protoc_insertion_point(field_get:UA_package_delivered.seqnum)
  return seqnum_;
}
inline void UA_package_delivered::set_seqnum(::google::protobuf::int64 value) {
  set_has_seqnum();
  seqnum_ = value;
  // @@protoc_insertion_point(field_set:UA_package_delivered.seqnum)
}
...
// repeated int64 acks = 3;
inline int UA_commands::acks_size() const {
  return acks_.size();
}
inline void UA_commands::clear_acks() {
  acks_.Clear();
}
inline ::google::protobuf::int64 UA_commands::acks(int index) const {
  // @@protoc_insertion_point(field_get:UA_commands.acks)
  return acks_.Get(index);
}
inline void UA_commands::set_acks(int index, ::google::protobuf::int64 value) {
  acks_.Set(index, value);
  // @@protoc_insertion_point(field_set:UA_commands.acks)
}
inline void UA_commands::add_acks(::google::protobuf::int64 value) {
  acks_.Add(value);
  // @@protoc_insertion_point(field_add:UA_commands.acks)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
UA_commands::acks() const {
  // @@protoc_insertion_point(field_list:UA_commands.acks)
  return acks_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
UA_commands::mutable_acks() {
  // @@protoc_insertion_point(field_mutable_list:UA_commands.acks)
  return &acks_;
}
...
// repeated int64 acks = 3;
inline int AU_commands::acks_size() const {
  return acks_.size();
}
inline void AU_commands::clear_acks() {
  acks_.Clear();
}
inline ::google::protobuf::int64 AU_commands::acks(int index) const {
  // @@protoc_insertion_point(field_get:AU_commands.acks)
  return acks_.Get(index);
}
inline void AU_commands::set_acks(int index, ::google::protobuf::int64 value) {
  acks_.Set(index, value);
  // @@protoc_insertion_point(field_set:AU_commands.acks)
}
inline void AU_commands::add_acks(::google::protobuf::int64 value) {
  acks_.Add(value);
  // @@protoc_insertion_point(field_add:AU_commands.acks)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
AU_commands::acks() const {
  // @@protoc_insertion_point(field_list:AU_commands.acks)
  return acks_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
AU_commands::mutable_acks() {
  // @@protoc_insertion_point(field_mutable_list:AU_commands.acks)
  return &acks_;
}
